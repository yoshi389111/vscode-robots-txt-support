...
export interface DirectiveInfo {
  ...
  /** The scope of this directive, indicating whether it applies globally or to a specific user-agent. */
 ...
 */
export const DIRECTIVE_LOOKUP: Readonly<Record<string, DirectiveInfo>> = {
  "user-agent": {
    name: "User-agent",
